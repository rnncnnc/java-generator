...
import com.qinge.backend.service.UserContactService;
...
public class UserContactController {
    ...
    @PostMapping("/insert")
    public Result insert(@RequestBody UserContactPojo pojo) {
        Query<UserContactPojo> query = new Query<>();
    ...
    public Result delete(@RequestBody UserContactPojo pojo) {
