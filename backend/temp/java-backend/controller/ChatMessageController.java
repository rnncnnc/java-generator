...
import com.qinge.backend.service.ChatMessageService;
...
public class ChatMessageController {
    ...
    @PostMapping("/insert")
    public Result insert(@RequestBody ChatMessagePojo pojo) {
        Query<ChatMessagePojo> query = new Query<>();
    ...
    public Result delete(@RequestBody ChatMessagePojo pojo) {
