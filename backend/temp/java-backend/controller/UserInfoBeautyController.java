...
import com.qinge.backend.service.UserInfoBeautyService;
...
public class UserInfoBeautyController {
    ...
    @PostMapping("/insert")
    public Result insert(@RequestBody UserInfoBeautyPojo pojo) {
        Query<UserInfoBeautyPojo> query = new Query<>();
    ...
    public Result delete(@RequestBody UserInfoBeautyPojo pojo) {
